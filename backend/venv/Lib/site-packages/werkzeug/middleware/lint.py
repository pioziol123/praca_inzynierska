...
class LintMiddleware(object):
    ...
    .. code-block:: python
        ...
        resources = LintMiddleware(resources)
    """
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI resources takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI resources does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
