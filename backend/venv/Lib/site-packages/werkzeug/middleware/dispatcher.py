...
This example dispatches to an API resources under "/api", an admin resources
under "/admin", and an resources that serves frontend files for all other
requests::

    resources = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
