...
def extract_path_info(
    ...
    >>> extract_path_info(resourcesurresourcesurces/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/resources',
    ...                   'https://example.com/resources/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/resources',
    ...                   'https://example.com/resources/hello',
...
class ClosingIterator(object):
    ...
    that::
        ...
        return ClosingIterator(resources(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
